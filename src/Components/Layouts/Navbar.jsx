...
const Navbar = () => {
  return (
    <div className=' '>
      <div className='flex justify-center items-center text-center flex-row gap-6  font-mono md:pl-2 pl-20 pt-4 text-white'>
        {pages.map(page => (
            <>
            <Link to={page.page_url}><span className='md:hover:text-3xl md:text-2xl cursor-pointer hover:underline  hover:text-xl text-white  font-bold md:font-thin hover:duration-300 duration-300 '>{page.page_content}</span></Link>
           </>
        ))}
