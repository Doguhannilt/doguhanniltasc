...
const Navbar = () => {
  return (
    <div className='bg-gray-800/30 pb-4 '>
      <div className='flex justify-center items-center text-center flex-row gap-6  font-mono pl-4 pt-4 '>
          ...
          <Link to={"/pages/Blogs"} exact><span className='md:hover:text-3xl md:text-2xl cursor-pointer  hover:text-xl  font-bold md:font-thin hover:duration-300 duration-300 '>Blogs</span></Link>
          <span onClick={GetEmail} className='md:hover:text-3xl  md:text-2xl cursor-pointer  hover:text-xl  font-bold md:font-thin hover:duration-300 duration-300 '>Reach Me!</span>
