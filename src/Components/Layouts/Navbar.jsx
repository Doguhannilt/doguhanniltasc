  ...
  return (
    <div className=' '>
      <div className='flex justify-center items-center text-center flex-row gap-6  font-mono pl-2 pt-4 '>
        {pages.map(page => (
            <>
            <Link to={page.page_url}><span className='md:hover:text-3xl md:text-2xl cursor-pointer  hover:text-xl  font-bold md:font-thin hover:duration-300 duration-300 '>{page.page_content}</span></Link>
           </>
        ))}
