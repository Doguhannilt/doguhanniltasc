  ...
  return (
    <div className=' '>
      <div className='flex justify-center items-center text-center flex-row gap-6  font-mono pl-2 pt-4 '>
          ...
          <Link to={"/Resume"} exact="true"><span className='md:hover:text-3xl md:text-2xl cursor-pointer  hover:text-xl  font-bold md:font-thin hover:duration-300 duration-300 '>Resume</span></Link>
